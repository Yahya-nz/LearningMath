...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h4 class="logo me-auto"><a href="index.php">IMath</a></h4>
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/1.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Welcome to <span>IMath</span></h2>
              <p class="animate__animated animate__fadeInUp">Anak menjadi gemar belajar saat yang dipelajari berhubungan dengan dunia mereka. Materi kami kemas dalam cerita empat sekawan yang memiliki talenta masing-masing, sehingga ilmu menjadi hidup, aplikatif, dan relevan</p>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/2.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Pikiran adalah api yang harus dinyalakan, bukan bejana yang harus diisi</h2>
              <p class="animate__animated animate__fadeInUp">Aktif dalam belajar, jangan hanya menunggu untuk menciptakan sesuatu yang berarti. Biasakan diri menjadi seorang pionner, bukan hanya sekedar followers. </p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/3.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Apa pun dirimu, jadilah yang <span>baik</span></h2>
              <p class="animate__animated animate__fadeInUp">Fokus dengan segala impian, harapan, cita-citamu dan jadilah yang terbaik di bidang yang kamu geluti.</p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
            </div>
          </div>
        </div>
